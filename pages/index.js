      ...
      <div className={styles.textContainer}>
        ...
        <div className={styles.description}>
          <div className={styles.descriptionText}>
            ...
            build the best construction camera software in the world. I design
            and code thoughtful products. I was previously the Founding Designer
            at a fantasy sports startup called{" "}
            <LinkPreview
